...
func TestShouldSuccesfullyRegistrateAnUser(t *testing.T) {
	...
	BadWordsRepository.On("FindAll").Return([]string{"shit", "fuck", "racecar"}, nil)
...
func TestShouldNotRegistrateTheUserWhenBadWordIsFound(t *testing.T) {
	...
	user := entity.User{
		Name:        "Vincent",
		Email:       "example@gmail.com",
		Description: "shit Software developer",
	}
